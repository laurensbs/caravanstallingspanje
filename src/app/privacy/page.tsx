        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="flex gap-12">
            ...
            <div className="flex-1 max-w-3xl prose-custom space-y-6 text-gray-500 text-sm leading-relaxed">
              ...
              <h2 id="verwerkingsverantwoordelijke" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">1. Verwerkingsverantwoordelijke</h2>
              ...
              <h2 id="welke-gegevens" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">2. Welke gegevens verzamelen wij?</h2>
              ...
              <h2 id="grondslag" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">3. Grondslag en doeleinden</h2>
              ...
              <h2 id="bewaartermijn" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">4. Bewaartermijn</h2>
              ...
              <h2 id="derden" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">5. Delen met derden</h2>
              ...
              <h2 id="rechten" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">6. Uw rechten</h2>
              ...
              <h2 id="cookies" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">7. Cookies</h2>
              ...
              <h2 id="beveiliging" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">8. Beveiliging</h2>
              ...
              <h2 id="klachten" className="text-xl font-bold text-gray-900 mt-8 mb-3 scroll-mt-28">9. Klachten</h2>
