...
export default function GlobalError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <html lang="nl">
      <body className="bg-[#FBF8F4] min-h-screen flex items-center justify-center p-6">
        <div className="max-w-md text-center">
          ...
          <button onClick={reset} className="bg-[#C4653A] hover:bg-[#A34E28] text-white font-bold px-6 py-3 rounded-xl transition-colors">
            Opnieuw proberen
          </button>
        </div>
      </body>
