...
const ROLE_COLORS: Record<string,string> = { beheerder: 'bg-purple-100 text-purple-700', medewerker: 'bg-blue-100 text-blue-700', chauffeur: 'bg-amber-100 text-amber-700', technicus: 'bg-green-100 text-green-700' };
