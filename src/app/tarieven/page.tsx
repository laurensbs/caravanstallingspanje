...
export default function TarievenPage() {
  ...
  const cats: Cat[] = [
    ...
    },
    {
      ...
      rows: [
        { keyL: 'pri1.cat-clean-row-1', price: '€85' },
        { keyL: 'pri1.cat-clean-row-2', price: '€95' },
        { keyL: 'pri1.cat-clean-row-3', price: '€55' },
        { keyL: 'pri1.cat-clean-row-4', price: '€225', featured: true },
      ],
    },
    {
      titleKey: 'pri1.cat-maint',
      rows: [
        { keyL: 'pri1.cat-maint-row-1', price: '€65' },
        { keyL: 'pri1.cat-maint-row-2', price: '€55' },
        { keyL: 'pri1.cat-maint-row-3', price: '€75' },
        { keyL: 'pri1.cat-maint-row-4', price: '€185', featured: true },
      ],
    },
    {
      titleKey: 'pri1.cat-rental',
      rows: [
        { keyL: 'pri1.cat-rental-row-1', price: '€40 / wk' },
        { keyL: 'pri1.cat-rental-row-2', price: '€28 / wk' },
        { keyL: 'pri1.cat-rental-row-3', price: '€55 / wk' },
      ],
    },
    {
      titleKey: 'pri1.cat-inspection',
      rows: [
        { keyL: 'pri1.cat-inspection-row-1', price: '€95' },
        { keyL: 'pri1.cat-inspection-row-2', price: '€145' },
      ],
    },
    {
      titleKey: 'pri1.cat-transport',
      rows: [
        { keyL: 'pri1.cat-transport-row-1', price: onRequest },
        { keyL: 'pri1.cat-transport-row-2', price: onRequest },
