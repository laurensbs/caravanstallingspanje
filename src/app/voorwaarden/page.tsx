  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <h1 className="text-3xl sm:text-4xl font-black mb-8">Algemene Voorwaarden</h1>
        <div className="prose-custom space-y-6 text-warm-gray text-sm leading-relaxed">
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 1 — Definities</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 2 — Toepasselijkheid</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 3 — Stallingsovereenkomst</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 4 — Tarieven en betaling</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 5 — Beveiliging en verzekering</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 6 — Onderhoud en reparatie</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 7 — Aansprakelijkheid</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 8 — Opzegging</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 9 — Toepasselijk recht</h2>
          ...
          <h2 className="text-xl font-bold text-surface-dark mt-8 mb-3">Artikel 10 — Contact</h2>
