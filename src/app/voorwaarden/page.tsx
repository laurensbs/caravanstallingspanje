        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="flex gap-12">
            ...
            <div className="flex-1 max-w-3xl prose-custom space-y-6 text-warm-gray text-sm leading-relaxed">
              ...
              <h2 id="definities" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 1 — Definities</h2>
              ...
              <h2 id="toepasselijkheid" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 2 — Toepasselijkheid</h2>
              ...
              <h2 id="overeenkomst" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 3 — Stallingsovereenkomst</h2>
              ...
              <h2 id="tarieven" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 4 — Tarieven en betaling</h2>
              ...
              <h2 id="beveiliging" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 5 — Beveiliging en verzekering</h2>
              ...
              <h2 id="onderhoud" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 6 — Onderhoud en reparatie</h2>
              ...
              <h2 id="aansprakelijkheid" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 7 — Aansprakelijkheid</h2>
              ...
              <h2 id="opzegging" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 8 — Opzegging</h2>
              ...
              <h2 id="recht" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 9 — Toepasselijk recht</h2>
              ...
              <h2 id="contact" className="text-xl font-bold text-surface-dark mt-8 mb-3 scroll-mt-28">Artikel 10 — Contact</h2>
