...
export const STRINGS = {
  ...
  'home2.about-p1': {
    nl: 'Caravanstalling Spanje is meer dan een opslagplek. We zijn een familiebedrijf met een vast Nederlands-Spaans team, eigen vrachtwagens en een werkplaats van 850 m² waar we caravans onderhouden, repareren en klaarmaken voor de zomer.',
    en: 'Caravanstalling Spanje is more than a storage facility. We\'re a family business with a fixed Dutch-Spanish team, our own trucks and an 850 m² workshop where we maintain, repair and prepare caravans for summer.',
  },
  'home2.about-p2': {
  ...
  'pri1.cat-transport-row-1': { nl: 'Stalling → camping (enkele rit)', en: 'Storage → campsite (one way)' },
  'pri1.cat-transport-row-2': { nl: 'Camping → stalling (enkele rit)', en: 'Campsite → storage (one way)' },
  ...
  'abo1.tl-4-d': { nl: 'Transport tussen onze stalling en je camping aan de Costa Brava — eigen vrachtwagens en vaste chauffeurs.', en: 'Transport between our storage and your campsite on the Costa Brava — own trucks and fixed drivers.' },
  ...
  'faq1.q-svc-3-a': { nl: 'Heen en terug tussen onze stalling en je camping aan de Costa Brava. Wij halen op of bezorgen op de afgesproken plek op de camping.', en: 'Round trip between our storage and your campsite on the Costa Brava. We collect or deliver at the agreed spot on the campsite.' },
  // FAQ items — Betaling
