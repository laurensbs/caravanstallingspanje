...
export const STRINGS = {
  ...
  'pri1.note-3': { nl: 'Vaste klanten krijgen 10% korting op onderhouds-pakketten in laagseizoen.', en: 'Loyal customers get 10% off maintenance packages in low season.' },
  'pri1.note-4': { nl: 'Reparatie wordt op uurbasis afgerekend (€55/u) of vaste prijs in offerte.', en: 'Repairs billed hourly (€55/h) or fixed price in quote.' },
