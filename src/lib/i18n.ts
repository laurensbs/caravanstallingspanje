...
export const STRINGS = {
  ...
  'ins1.list-cat-1-2': { nl: 'Chassis, dissel, neuswiel', en: 'Chassis, drawbar, jockey wheel' },
  'ins1.list-cat-1-3': { nl: 'Wiellagers, naven, schokdempers', en: 'Wheel bearings, hubs, shock absorbers' },
  'ins1.list-cat-1-4': { nl: 'Remvoeringen, handrem, terugrij-automaat', en: 'Brake linings, handbrake, reverse mechanism' },
  'ins1.list-cat-2': { nl: 'Opbouw', en: 'Bodywork' },
  'ins1.list-cat-2-1': { nl: 'Bevestiging opbouw + vloer', en: 'Body + floor mounting' },
  'ins1.list-cat-2-2': { nl: 'Bodemplaat (vochtcontrole)', en: 'Floor (moisture check)' },
  'ins1.list-cat-2-3': { nl: 'Reflectoren, kentekenplaat, lijstwerk', en: 'Reflectors, plate, trim' },
  'ins1.list-cat-2-4': { nl: 'Bevestiging leidingen + rangeergrepen', en: 'Pipe + handle mounting' },
  'ins1.list-cat-3': { nl: 'Electro', en: 'Electrical' },
  'ins1.list-cat-3-1': { nl: 'Netaansluiting 230 V + zekeringen', en: 'Mains 230V + fuses' },
  'ins1.list-cat-3-2': { nl: '12V installatie, accu, omvormer', en: '12V system, battery, inverter' },
  'ins1.list-cat-3-3': { nl: 'Verlichting, knipperlichten, remlichten', en: 'Lighting, indicators, brake lights' },
  'ins1.list-cat-3-4': { nl: '7/13-polige stekker, contour-licht', en: '7/13-pin plug, contour lighting' },
  'ins1.list-cat-4': { nl: 'Gas', en: 'Gas' },
  'ins1.list-cat-4-1': { nl: 'Gasleidingen + drukregelaar (max 10 jr)', en: 'Gas lines + regulator (max 10 yr)' },
  'ins1.list-cat-4-2': { nl: 'Gasslang + flessen-controle', en: 'Gas hose + bottle check' },
  'ins1.list-cat-4-3': { nl: 'Koelkast, gasstel, kachel', en: 'Fridge, stove, heater' },
  'ins1.list-cat-4-4': { nl: 'Afvoer kachel + ventilatie', en: 'Heater outlet + ventilation' },
  'ins1.list-cat-5': { nl: 'Banden', en: 'Tyres' },
  'ins1.list-cat-5-1': { nl: 'Profielhoogte per wiel (min 1,6 mm)', en: 'Profile depth per wheel (min 1.6 mm)' },
  'ins1.list-cat-5-2': { nl: 'Bandenspanning controle (BAR)', en: 'Tyre pressure check (BAR)' },
  'ins1.list-cat-5-3': { nl: 'DOT-code per band (leeftijd)', en: 'DOT code per tyre (age)' },
  'ins1.list-cat-5-4': { nl: 'Reservewiel + velgen', en: 'Spare wheel + rims' },
  'ins1.list-cat-6': { nl: 'Veiligheid', en: 'Safety' },
  'ins1.list-cat-6-1': { nl: 'Breekkabel + handrem-werking', en: 'Breakaway cable + handbrake function' },
  'ins1.list-cat-6-2': { nl: 'Remkabels + noodvoorziening', en: 'Brake cables + emergency systems' },
  'ins1.list-cat-6-3': { nl: 'Reflecterende strepen + zicht', en: 'Reflective strips + visibility' },
