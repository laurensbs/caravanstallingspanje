    ...
    <footer className="relative bg-primary-dark text-white/60 overflow-hidden">
      ...
      <div className="relative border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="bg-gradient-to-r from-accent/10 via-accent/5 to-transparent rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 border border-accent/10">
            <div>
              <h3 className="text-white text-2xl md:text-3xl font-bold mb-2">Klaar om uw caravan veilig te stallen?</h3>
              <p className="text-white/50 text-sm max-w-lg">Vraag vandaag nog een vrijblijvende offerte aan. Wij reageren binnen 24 uur.</p>
            </div>
            <Link
              href="/contact"
              className="shrink-0 bg-gradient-to-r from-accent to-accent-light hover:from-accent-light hover:to-accent text-primary-dark font-bold px-8 py-4 rounded-2xl text-sm transition-all duration-300 shadow-lg shadow-accent/20 hover:shadow-accent/40 hover:scale-[1.02] inline-flex items-center gap-2"
            >
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            <div className="flex items-center gap-2.5 mb-5">
              <div className="w-9 h-9 bg-gradient-to-br from-accent to-accent-light rounded-xl flex items-center justify-center shadow-lg shadow-accent/10">
                <span className="text-primary-dark font-black text-xs">CS</span>
              </div>
              <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              Dé specialist in het veilig stallen, onderhouden en transporteren van uw caravan aan de Costa Brava. Al meer dan 10 jaar een begrip.
            </p>
          ...
          <motion.div variants={fadeUp}>
            <h4 className="text-white font-bold text-sm mb-5 flex items-center gap-2">
              <Wrench size={14} className="text-accent" /> Diensten
            </h4>
          ...
          <motion.div variants={fadeUp}>
            <h4 className="text-white font-bold text-sm mb-5 flex items-center gap-2">
              <Shield size={14} className="text-accent" /> Snelle links
            </h4>
            <ul className="space-y-2.5">
              {[
          ...
          <motion.div variants={fadeUp}>
            <h4 className="text-white font-bold text-sm mb-5 flex items-center gap-2">
              <Truck size={14} className="text-accent" /> Contact
            </h4>
      ...
      <div className="border-t border-white/5 py-5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
          <p>&copy; {new Date().getFullYear()} Caravan Storage Spain S.L. Alle rechten voorbehouden.</p>
